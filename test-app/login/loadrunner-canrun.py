...
#parser.add_argument("-ne", "--number_of_experiments", type=int, default=100, help="Total number of requests to server")
parser.add_argument("-wl", "--workload", type=str, default='Login', help="Workload name")
parser.add_argument("-wl2", "--workload2", type=str, default='Login2', help="Workload2 name")
...
def deploy_functions():
    deploy_command = 'wsk --apihost http://%s action update -i %s ./target/login.jar --main ch.ethz.systems.Login --docker openwhisk/java8action -c %s'

...
set ylabel "Normalized startup time" font ",9" #offset 2
...
plot \
  "tmp/sleep.txt" using 1:2 title "Sleep" with lines lc rgb "#4287f5" lw 1.5 dt 2, \
  "tmp/image_classification.txt" using 1:2 title "Image classification" with lines lc rgb "#fcbd35" lw 1.5 lt 2, \
   "tmp/file_hashing.txt" using 1:2 title "File hashing" with lines lc rgb "#c625cf" lw 1.5 lt 3, \
   "tmp/video.txt" using 1:2 title "Video" with lines lc rgb "#00875c" lw 1.5 dt 3

...
plot \
  "data/data.txt" using 1:3 title "Sleep" with lines lc rgb "#4287f5" lw 1.5 dt 2, \
  "data/data.txt" using 1:4 title "Image Class." with lines lc rgb "#fcbd35" lw 1.5 lt 2, \
  "data/data.txt" using 1:2 title "File hashing" with lines lc rgb "#c625cf" lw 1.5 lt 3, \
  "data/data.txt" using 1:5 title "Video" with lines lc rgb "#00875c" lw 1.5 dt 3

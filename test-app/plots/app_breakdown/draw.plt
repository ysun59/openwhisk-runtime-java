...
set output "./output/app_memory_breakdown.pdf"
...
plot \
  ...
  "./data/image_classification.txt" using (($3)) title "Image Class."  with histogram lc rgb "#D2691E" fs pattern 10, \

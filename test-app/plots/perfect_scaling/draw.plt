...
plot \
  "data/data.txt" using 1:2 title "AWS Lambda" with lines lc rgb "#4287f5" lw 1.5 dt 2, \
  "data/data.txt" using 1:3 title "Java ideal" with lines lc rgb "#fcbd35" lw 1.5 lt 2, \
  "data/data.txt" using 1:4 title "Python ideal" with lines lc rgb "#c625cf" lw 1.5 lt 3
